                            ...
                            <div class="col-lg-6 col-md-6 mb-5">
                                ...
                                <div class="d-flex">
                                    <div class="me-3">
                                        ...
                                        <p style="font-size: 14px;"><i class="bi bi-clock-fill"></i> {{
                                            $detail->durasi_waktu }} {{ __('label.jam') }}</p>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-12 col-md-12">
                                        ...
                                        <form action="/add_cart" method="POST">
                                            ...
                                            <input type="hidden" name="type" value="pesawat">
                                        ...
                                        <div class="col-md-3 mb-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="text-center">
                                                    ...
                                                    <h4><i class="fa-solid fa-plane-arrival"></i> {{ $detail->terminal2
                                                        }}</h4>
                                                </div>
                                            </div>
                                        </div>
