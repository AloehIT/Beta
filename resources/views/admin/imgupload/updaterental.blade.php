<div class="row mt-3">
  ...
  <div class="col-md-12">
    <p class="image-upload_produk2 m-0">
      <label class="img-upload_produk2 m-0 p-0">
        <img src="{{ URL::to('assets/admin.assets/icon/car/utama.jpg') }}" alt="" class="img1 foto-upload_produk2 img-fluid mt-0"
          id="upload6">
  ...
  <div class="col-md-6">
    <p class="image-upload_produk1 m-0">
      <label class="img-upload_produk1 m-0 p-0">
        <img src="{{ URL::to('assets/admin.assets/icon/car/front.jpg') }}" alt="" class="img2 foto-upload_produk1 img-fluid mt-0"
          id="upload7">
  ...
  <div class="col-md-6">
    <p class="image-upload_produk1 m-0">
      <label class="img-upload_produk1 m-0 p-0">
        <img src="{{ URL::to('assets/admin.assets/icon/car/behind.jpg') }}" alt="" class="img3 foto-upload_produk1 img-fluid mt-0"
          id="upload8">
  ...
  <div class="col-md-6">
    <p class="image-upload_produk1 m-0">
      <label class="img-upload_produk1 m-0 p-0">
        <img src="{{ URL::to('assets/admin.assets/icon/car/side.jpg') }}" alt="" class="img4 foto-upload_produk1 img-fluid mt-0"
          id="upload9">
  ...
  <div class="col-md-6">
    <p class="image-upload_produk1 m-0">
      <label class="img-upload_produk1 m-0 p-0">
        <img src="{{ URL::to('assets/admin.assets/icon/car/sidebehind.jpg') }}" alt="" class="img5 foto-upload_produk1 img-fluid mt-0"
          id="upload10">
