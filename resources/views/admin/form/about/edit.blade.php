        ...
        <div class="modal-body">
            <form action="{{ route('update.about') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="text-center mt-3">
                    <input type="file" name="image_tentangkami" id="actual-btn1" onchange="loadFile1(event)"
                        hidden />
                ...
                <div class="col-md-12 mt-2">
                    ...
                    <input id="updescription" type="hidden" name="description" class="description">
                    <trix-editor input="updescription" class="description"></trix-editor>
                </div>
...
<script>
    $(document).on("click", ".sendAbout", function () {
     var id = $(this).data('id');
     ...
     $(".modal-body .viewimage").attr("src", "../library/about/"+img);
