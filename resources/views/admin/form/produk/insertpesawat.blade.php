<div class="modal fade" id="addpesawat" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                    ...
                    <div class="tab-pane fade show">
                        <div class="card">
                            ...
                            <div class="card-body row mx-1">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            @include('admin.imgupload.insertpesawat')
                                        </div>
                                        ...
                                        <div class="col-md-6 pt-5 ">
                                            <div class="col-md-6">
                                                ...
                                                <p class="upload_logo m-0" style="border: 4px solid #EEEEEE; width: 120px; height: 110px;">
                                                  <label class="img-upload_logo m-0 p-0">
                                                    <img src="{{ URL::to('assets/admin.assets/icon/plane/brand.jpg') }}" alt="" class="foto-upload_logo img-fluid mt-0"
                                                      id="viewlogo3">
                                            
                                                    <label class="btn-input_logo">
                                                      <input type="file" name="logo" onchange="loadLogo3(event)" required>
                                            ...
                                            <div class="row">
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <select id="sub11" class="form-control" name="sub1" required> 
                                                ...
                                                <div class="col-md-6 mb-1">
                                                    ...
                                                    <select id="sub21" class="form-control" name="sub2" required>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-12 mb-1">
                                ...
                                <input id="insertketpesawat" type="hidden" name="keterangan">
                                <trix-editor input="insertketpesawat"></trix-editor>
                            </div>
            
                            <div class="col-md-12 mb-3">
                                <label for="description" class="form-label"
                                    style="font-size: 18px;">Description (EN)</label>
                                <input id="insertdescpesawat" type="hidden" name="descreption">
                                <trix-editor input="insertdescpesawat"></trix-editor>
                            </div>
                        </div>
        ...
        if(sub1){
            $.ajax({
                ...
                success:function(data){        
                    ...
                    if(data){
                        $("#sub11").empty();
                        $("#sub11").append('<option>-- Pilih Kategori --</option>');

                        $.each(data,function(key, subkategori1){
                            $("#sub11").append('<option value="'+subkategori1.subkategori+'">'+subkategori1.subkategori+'</option>');
                        });
                    }else{
                        $("#sub11").empty();
                    }
        ...
        if(sub1){
            $.ajax({
                ...
                success:function(data){        
                    ...
                    if(data){
                        $("#sub21").empty();
                        $("#sub21").append('<option>-- Pilih Kategori --</option>');

                        $.each(data,function(key, subkategori2){
                            $("#sub21").append('<option value="'+subkategori2.subkategori+'">'+subkategori2.subkategori+'</option>');
                        });
                    }else{
                        $("#sub21").empty();
                    }
