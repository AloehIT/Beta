                    ...
                    <div id="productslider" class="carousel slider">
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-6 mb-5">
                                ...
                                <p class="text-capitalize"><b>{{ __('label.prov') }} {{ $detail->prov }} | {{ __('label.kab') }} {{ $detail->kab }} | {{ __('label.kec') }} {{ $detail->kec }}</b></p>
                                <p class="mt-2">{{ $detail->alamat }}</p>
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-md-3 mb-3">
                                            <div class="mb-3 text-center">
                                                ...
                                                <h4 class="mb-2"><i class="fa-solid fa-bed"></i> {{ $detail->nilai }} {{ __('label.bedsleep') }}</h4>

                                                @if($detail->fasilitas5 == "1")
                                        ...
                                        <div class="col-md-3">
                                            <div class="text-center">
                                                <h3>{{ __('label.labelfasilitastambahan') }}</h3>
