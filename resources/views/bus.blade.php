    ...
    <div class="fullwidth-block">
        <div class="container">
            ...
            <div class="mb-2">
                ...
                <a href="{{ route('bus') }}" class="btn mb-1 text-white"
        ...
        if(kab){
            $.ajax({
                ...
                success:function(data){        
                    ...
                    if(data){
                        $("#kab").empty();
                        $("#kab").append('<option>{{__('label.berangkat')}}</option>');

                        $("#kab1").empty();
                        $("#kab1").append('<option>{{__('label.tujuan')}}</option>');
        ...
        if(kab){
            $.ajax({
                ...
                success:function(data){        
                    ...
                    if(data){
                        $("#kab2").empty();
                        $("#kab2").append('<option>{{__('label.berangkat')}}</option>');

                        $("#kab3").empty();
                        $("#kab3").append('<option>{{__('label.tujuan')}}</option>');
