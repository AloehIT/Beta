<div class="row mt-3">
  ...
  <div class="col-md-12">
    <p class="image-upload_produk2 m-0">
      <label class="img-upload_produk2 m-0 p-0">
        <img src="{{ URL::to('assets/admin.assets/icon/bus/bus.png') }}" alt="" class="img1 foto-upload_produk2 img-fluid mt-0"
          id="upload">
  ...
  <div class="col-md-6">
    <p class="image-upload_produk1 m-0">
      <label class="img-upload_produk1 m-0 p-0">
        <img src="{{ URL::to('assets/admin.assets/icon/bus/bus.png') }}" alt="" class="img2 foto-upload_produk1 img-fluid mt-0"
          id="upload2">
  ...
  <div class="col-md-6">
    <p class="image-upload_produk1 m-0">
      <label class="img-upload_produk1 m-0 p-0">
        <img src="{{ URL::to('assets/admin.assets/icon/bus/bus.png') }}" alt="" class="img3 foto-upload_produk1 img-fluid mt-0"
          id="upload3">
  ...
  <div class="col-md-6">
    <p class="image-upload_produk1 m-0">
      <label class="img-upload_produk1 m-0 p-0">
        <img src="{{ URL::to('assets/admin.assets/icon/bus/bus.png') }}" alt="" class="img4 foto-upload_produk1 img-fluid mt-0"
          id="upload4">
  ...
  <div class="col-md-6">
    <p class="image-upload_produk1 m-0">
      <label class="img-upload_produk1 m-0 p-0">
        <img src="{{ URL::to('assets/admin.assets/icon/bus/bus.png') }}" alt="" class="img5 foto-upload_produk1 img-fluid mt-0"
          id="upload5">
