...
@section('subtitle', 'Testimoni Pelanggan')
@section('content')
    ...
    <div class="container-fluid py-4">
        ...
        <div class="container">
            <div class="container row mt-4 mb-5">
                <div class="col-md-6">
                    <div>
                      <img src="{{ url('library/testimoni/'. $data->image_testimoni) }}" alt="" class="img-fluid" width="450">
                    </div> 
                </div>
                ...
                <div class="col-md-6 my-5">
                    ...
                    <div class="col-md-12">
                        <a data-bs-toggle="modal" data-judul="{{$data->judul}}" data-title="{{$data->title}}" data-id="{{$data->id}}" data-keterangan="{{ $data->keterangan }}" data-description="{{ $data->description }}" data-level="{{ $data->level }}" data-img="{{ $data->image_testimoni }}" class="sendTestimoni">
        ...
        <div class="container">
            <div class="container row mt-4 mb-3">
                <div class="col-md-4">
                    <img src="{{ url('library/testimoni/'. $data->image_testimoni) }}" alt="" width="250" height="250" class="rounded-circle">
                </div>
    ...
    <div class="modal-dialog modal-md">
      <div class="modal-content">
        <div class="modal-body">
            <form action="{{ route('add.testimoni') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                ...
                <div class="col-md-12 mt-2">
                    ...
                    <input id="inketerangan" type="hidden" name="keterangan">
                    <trix-editor input="keterangan"></trix-editor>
                </div>

                <div class="col-md-12 mt-2">
                    <label class="form-label text-dark">Description (EN)</label>
                    <input id="indescription" type="hidden" name="description">
...
@include('admin.form.testimoni.edit')
