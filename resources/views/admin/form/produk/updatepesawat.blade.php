<div class="modal fade" id="uppesawat" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
                    ...
                    <div class="tab-pane fade show">
                        <div class="card">
                            ...
                            <div class="card-body row mx-1">
                                <input type="hidden" name="tipe_produk" value="pesawat">
                                ...
                                <div class="col-md-12">
                                    <div class="row">
                                        <div class="col-md-6">
                                            @include('admin.imgupload.updatepesawat')
                                        </div>
                                        ...
                                        <div class="col-md-6 pt-5 ">
                                                ...
                                                <p class="upload_logo m-0" style="border: 4px solid #EEEEEE; width: 120px; height: 110px;">
                                                  <label class="img-upload_logo m-0 p-0">
                                                    ...
                                                    <label class="btn-input_logo">
                                                      <input type="file" name="logo" onchange="uploadLogo3(event)">
                                            ...
                                            <div class="mb-1 col-md-12">
                                                ...
                                                <div class="input-group">
                                                    ...
                                                    <input type="number" class="form-control px-3" name="nilai"
                                                        placeholder="Jumlah tiket" min="1" required id="tiket">
                                                </div>
                                            </div>
                                            ...
                                            <div class="col-md-12 mb-1">
                                                ...
                                                <select id="upkategori2" class="form-control sendkategori3" required>
                                                ...
                                                <input type="hidden" class="kategori3" name="kategori" id="kategori">
                                            </div>
                
                                            <div class="row">
                                                <div class="col-md-6 mb-1">
                                                    <label class="form-label text-dark">Sub-kategori1</label>
                                                    <select id="upsub12" class="form-control sendsub14" required> 
                                                        <option selected disabled>-- Pilih Kategori --</option>
                                                    </select>
                                                    <p style="font-size: 11px;" class="mb-0">SUB1: <span id="beforesub1"></span></p>
                                                    <input type="hidden" class="sub14" name="sub1" id="sub1">
                                                </div>
                                    
                                                <div class="col-md-6 mb-1">
                                                    <label for="sub" class="form-label text-dark">Sub-kategori2</label>
                                                    <select id="upsub22" class="form-control sendsub24" required>
                                                        <option selected disabled>-- Pilih Kategori --</option>
                                                    </select>
                                                    <p style="font-size: 11px;" class="mb-0">SUB2: <span id="beforesub2"></span></p>
                                                    <input type="hidden" class="sub24" name="sub2" id="sub2">
                                                </div>
                                            </div>
                                            <!------------------------------------Kategori Utama Produk------------------------------------------->      
                                        </div>
                        ...
                        <div class="row mt-2">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text" style="background: #D6D6D6;"
                                                id="basic-addon1"><i class="fa-solid fa-plane-departure"></i></span>
                                    ...
                                    <div class="col-md-6">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text" style="background: #D6D6D6;"
                                                id="basic-addon1"><i class="fa-solid fa-plane-arrival"></i></span>
                            ...
                            <div class="col-md-12 mb-1">
                                ...
                                <input id="upketpesawat" type="hidden" name="keterangan" class="keterangan">
                                <trix-editor input="upketpesawat" class="keterangan"></trix-editor>
                            </div>
            
                            <div class="col-md-12 mb-3">
                                <label class="form-label text-dark">
                                    Short description (EN)</label>
                                <input id="updescpesawat" type="hidden" name="description" class="desc">
                                <trix-editor input="updescpesawat" class="desc"></trix-editor>
                            </div>
                        </div>
...
<script type="text/javascript">
    //send kategori
    $('.sendkategori3').on('change', function(){
        const kategori = $('.sendkategori3').val();
        $('.kategori3').val(kategori);
    });

    $('.sendsub14').on('change', function(){
        const subkategori = $('.sendsub14').val();
        $('.sub14').val(subkategori);
    });

    $('.sendsub24').on('change', function(){
        const subkategori = $('.sendsub24').val();
        $('.sub24').val(subkategori);
    });


    //Kategori
    $('#upkategori2').change(function(){
        var upsub = $(this).val();    
        ...
        if(upsub){
            $.ajax({
                ...
                success:function(data){        
                    ...
                    if(data){
                        $("#upsub12").empty();
                        $("#upsub12").append('<option>-- Pilih Kategori --</option>');

                        $.each(data,function(key, subkategori1){
                            $("#upsub12").append('<option value="'+subkategori1.subkategori+'">'+subkategori1.subkategori+'</option>');
                        });
                    }else{
                        $("#upsub12").empty();
                    }
        ...
        if(upsub){
            $.ajax({
                ...
                success:function(data){        
                    ...
                    if(data){
                        $("#upsub22").empty();
                        $("#upsub22").append('<option>-- Pilih Kategori --</option>');

                        $.each(data,function(key, subkategori2){
                            $("#upsub22").append('<option value="'+subkategori2.subkategori+'">'+subkategori2.subkategori+'</option>');
                        });
                    }else{
                        $("#upsub22").empty();
                    }
    ...
    $(document).on("click", ".passPesawat", function () {
