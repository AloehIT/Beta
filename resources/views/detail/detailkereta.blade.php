                            ...
                            <div class="col-lg-6 col-md-6 mb-5">
                                ...
                                <div class="d-flex">
                                    <div>
                                        ...
                                        <p class="text-capitalize" style="font-size: 13px;"><i class="fa-solid fa-train"></i> {{
                                            $detail->keberangkatan }}</p>
                                    </div>
                                ...
                                <div class="d-flex">
                                    <div class="me-3">
                                        ...
                                        <p style="font-size: 14px;"><i class="bi bi-clock-fill"></i> {{ $detail->durasi_waktu }} {{__('label.jam')}}</p>
                                    </div>
                                </div>
                                ...
                                <div class="d-lg-none">
                                    ...
                                    <p class="price text-end mt-1">
                                        @if($detail->harga_promo == "")
                                        <span class="text-dark" style="font-size: 23px;">@currency($detail->harga)</span>
                                        @else
                                        <span class="badge bg-success" style="font-size: 15px;">Promo</span>
                                        <span class="text-dark" style="font-size: 23px;">@currency($detail->harga)</span><br>
                                        <span class="old-price" style="font-size: 18px;">@currency($detail->harga_promo)</span>
                                        @endif
                                    </p>
                                </div>
                                <!----Harga End---->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-12 col-md-12">
                                        <a href="#" class="btn btn-success mt-3 col-12"><i class="fa-brands fa-shopify"></i> {{ __('label.btnpesan') }}</a>
                                        <form action="/add_cart" method="POST">
                                            @csrf
                                            <input type="hidden" name="id" value="{{$detail->kode_produk}}">
                                            <input type="hidden" name="harga" value="{{$detail->harga}}">
                                            <input type="hidden" name="type" value="kereta">
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-md-3 mb-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="text-center">
                                                    ...
                                                    <h4 class="text-capitalize"><i class="fa-solid fa-train"></i> {{ $detail->terminal1 }}</h4>
                                                </div>
                                                <h4 class="text-center"><i class="bi bi-arrow-down"></i></h4>
                                                <div class="text-center">
                                                    <p class="mb-0 text-dark"><b>{{ __('label.tujuan') }}</b></p>
                                                    <h4 class="text-capitalize"><i class="fa-solid fa-train"></i> {{ $detail->terminal2 }}</h4>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3 text-center">
                                                <h3>{{__('label.labelfasilitas')}}</h3>
                                                <h4 class="mb-2"><img src="{{ URL::to('assets/admin.assets/icon/chair.png') }}" class="img-fluid" width="20" alt=""> {{ $detail->nilai }} {{ __('label.kursi') }}</h4>
                                                @if($detail->fasilitas2 == "1")
                                                <h4 class="mb-2"><i class="bi bi-cup-hot-fill"></i> {{ __('label.makan') }} <span class="badge bg-success">{{ __('label.gratis') }}</span></h4>
                                                @else
                                                <h4 class="mb-2" style="text-decoration: line-through;"><i class="bi bi-cup-hot-fill"></i> {{ __('label.makan') }} <span class="badge bg-success">{{ __('label.gratis') }}</span></h4>
                                                @endif
                                            </div>
                                        </div>
