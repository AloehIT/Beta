  ...
  <div class="col-md-12">
    <p class="image-upload_produk2 m-0">
      <label class="img-upload_produk2 m-0 p-0">
        <img src="{{ URL::to('assets/admin.assets/icon/travel.png') }}" alt="" class="foto-upload_produk2 img-fluid mt-0"
          id="output">
  ...
  <div class="col-md-6">
    <p class="image-upload_produk1 m-0">
      <label class="img-upload_produk1 m-0 p-0">
        <img src="{{ URL::to('assets/admin.assets/icon/travel.png') }}" alt="" class="foto-upload_produk1 img-fluid mt-0"
          id="output1">
