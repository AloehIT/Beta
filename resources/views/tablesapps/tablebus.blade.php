                    ...
                    <div class="d-flex flex-row align-items-center">
                        <div class="ms-2 c-details">
                            <h6 class="mb-0 text-secondary text-capitalize" style="font-size: 10px;">
                                <i class="fa-solid fa-bus"></i> {!! Str::words($data->terminal1, 2, ' ...') !!} |
                                ...
                                <div class="d-flex">
                                    <div>
                                        ...
                                        <p style="font-size: 13px;" class="text-capitalize">
                                            <i class="fa-solid fa-bus"></i> {!! Str::words($data->keberangkatan, 1, ' ...') !!}
                                        </p>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <p style="font-size: 13px;" class="text-capitalize">
                                            <i class="fa-solid fa-bus"></i> {!! Str::words($data->tujuan, 1, ' ...') !!}
                                        </p>
                                    </div>
                                </div>
