...
<main class="content">
    ...
    <div class="fullwidth-block">
        <div class="container">
            ...
            <div class="mb-2">
                <a href="{{ route('produk') }}" class="btn mb-1 text-white"
            ...
            <div class="s003 mb-4 d-none d-lg-block d-md-block">
                <form action="{{ route('search.produkall') }}" method="GET">
                    {{ csrf_field() }}
                        ...
                        <div class="card">
                            <div class="card-body p-4">
                                ...
                                <div class="mb-2">
                                    ...
                                    <select x-model="formData.kategori" class="form-control text-secondary" id="kat"
                                ...
                                <div class="mb-2">
                                    ...
                                    <select class="form-control text-secondary text-capitalize" x-model="formData.sub1" value="{{ request('sub1') }}">
                                ...
                                <div class="mb-2">
                                    ...
                                    <select class="form-control text-secondary text-capitalize" x-model="formData.prov" id="prov1"
                                        value="{{ request('prov') }}">
                                ...
                                <div class="mb-2">
                                    <select class="form-control text-secondary text-capitalize" x-model="formData.kab" id="kab1"
                                        value="{{ request('kab') }}">
                                ...
                                <div class="mb-2">
                                    <select class="form-control text-secondary" x-model="formData.kec" id="kec1"
                                        value="{{ request('kec') }}">
                                ...
                                <div class="mb-2">
                                    ...
                                    <div class="mb-2">
                                        <input type="number" x-model="formData.min" class="form-control" min="0" placeholder="MIN"
                                            value="{{ request('min') }}">
                                    </div>
    
                                    <div>
                                        <input type="number" x-model="formData.max" class="form-control" min="0" placeholder="MAX"
                                            value="{{ request('max') }}">
                                    </div>
                                </div>
                                ...
                                <div class="mb-3">
                                    <div>
                                        ...
                                        <div>
                                            ...
                                            @if(Request::get('rating') == $star->ranting)
                                            <input type="checkbox" class="btn-check" x-model="formData.rating"
            ...
            <div class="row">
                <!---------------filter produk content::start------------->
                <div class="col-lg-3 col-md-5 col-12 mb-3 d-none d-lg-block d-md-block" x-data="Filter()">
                    <div class="card">
                        <div class="card-body p-4">
                            @if(app()->getLocale()=='id')
                            <p style="font-weight: 600; font-size: 18px;">Filter Lainnya</p>
                            ...
                            <div class="mb-2">
                                <label for="exampleInputEmail1" style="font-size: 12px;"
                                    class="form-label mb-1">{{ __('label.kategori') }}</label>
                                <select x-model="formData.kategori" class="form-control text-secondary text-capitalize" id="kat"
                                    value="{{ request('kategori') }}">
                                    <option value="" selected>{{ __('label.kategori') }}</option>
                                    @foreach($kategori as $item)
                                    @if($item->tipe == "Rental")
                            ...
                            <div class="mb-2">
                                <label class="form-label text-dark">{{ __('label.wilayah') }}</label>
                                <select class="form-control text-secondary text-capitalize" x-model="formData.prov" id="prov"
                                    value="{{ request('prov') }}">
                                    <option selected>{{ __('label.prov') }}</option>
                                    @foreach($provinsi as $item)
                                    @if(request('prov') == $item->provinsi)
                            ...
                            <div class="mb-2">
                                <select class="form-control text-secondary text-capitalize" x-model="formData.kab" id="kab"
                                    value="{{ request('kab') }}">
                                    <option selected>{{ __('label.kab') }}</option>
                                </select>
                            </div>
                            ...
                            <div class="mb-2">
                                <select class="form-control text-secondary text-capitalize" x-model="formData.kec" id="kec"
                                    value="{{ request('kec') }}">
                                    <option selected>{{ __('label.kec') }}</option>
                                </select>
                            </div>
                ...
                @include('tablesapps.tableproduk')
            </div>
        </div>
    </div>
