                        ...
                        <div class="row">
                                    ...
                                    <div class="col-12">
                                        <div class="carousel-inner">
                                            ...
                                            <div class="carousel-item active zoom-image">
                                                <img src="{{ asset('library/produk/'.$detail->img1) }}"
                                                    class="img-fluid" alt="" width="800" height="500">
                                            </div>

                                            <div class="carousel-item zoom-image">
                                                <img src="{{ asset('library/produk/'.$detail->img2) }}"
                                                    class="img-fluid" alt="" width="800" height="500">
                                            </div>

                                            <div class="carousel-item zoom-image">
                                                <img src="{{ asset('library/produk/'.$detail->img3) }}"
                                                    class="img-fluid" alt="" width="800" height="500">
                                            </div>

                                            <div class="carousel-item zoom-image">
                                                <img src="{{ asset('library/produk/'.$detail->img4) }}"
                                                    class="img-fluid" alt="" width="800" height="500">
                                            </div>

                                            <div class="carousel-item zoom-image">
                                                <img src="{{ asset('library/produk/'.$detail->img5) }}"
                                                    class="img-fluid" alt="" width="800" height="500">
                                            </div>
                            ...
                            <div class="col-lg-6 col-md-6 mb-5">
                                <div class="d-flex justify-content-between mb-0">
                                    @if($detail->tipe_produk == "bus")
                                    @if($detail->harga_promo == "")
                                    <div class="row">
                                        <div class="col-md-3">
                                            <img src="{{ asset('library/logoperusahaan/'. $detail->logo ) }}" alt=""
                                    ...
                                    <div>
                                        <a href="#" class="text-secondary mx-2"><i class="bi bi-share-fill"
                                ...
                                <div class="d-flex">
                                    <div>
                                        ...
                                        <p class="text-capitalize" style="font-size: 13px;"><i class="fa-solid fa-bus"></i> {{
                                    ...
                                    <div class="row mt-4">
                                        ...
                                        <div class="col-md-3 mb-4">
                                            <div class="mb-3">
                                                ...
                                                <div class="text-center">
                                                    ...
                                                    <h4 class="text-capitalize"><i class="bi bi-train-freight-front-fill"></i> {{
                                                        $detail->terminal1 }}</h4>
                                                </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="mb-3 text-center">
                                                ...
                                                <h4 class="mb-2"><img
                                                        src="{{ URL::to('assets/admin.assets/icon/chair.png') }}"
                                                        class="img-fluid" width="20" alt=""> {{ $detail->nilai }} {{ __('label.kursi') }}
                                                </h4>
                                                ...
                                                <h4 class="mb-2" style="text-decoration: line-through;"><i
                                                        class="bi bi-cup-hot-fill"></i> Sarapan <span
                                                        class="badge bg-success">{{ __('label.gratis') }}</span></h4>
                                                @endif
                                            </div>
                                        </div>
